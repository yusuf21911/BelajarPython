...
total_harga_keseluruhan = total_harga_kopi + total_harga_roti
total_kembalian = uang_bayar - total_harga_keseluruhan

print ("Harga Total Kopi: ", total_harga_kopi)
print ("Harga Total Roti: ", total_harga_roti)
print ("Harga Belanja Keseluruhan: ", total_harga_keseluruhan)
print ("Kembalian: ", total_kembalian)